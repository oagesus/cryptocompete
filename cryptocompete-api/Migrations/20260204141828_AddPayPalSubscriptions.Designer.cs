...
namespace cryptocompete_api.Migrations
{
    ...
    [Migration("20260204141828_AddPayPalSubscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.LeaderboardSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("PayPalPlanId")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("pay_pal_plan_id");

                    b.Property<string>("PayPalSubscriptionId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("pay_pal_subscription_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pay_pal_subscriptions");

                    b.HasIndex("PayPalSubscriptionId")
                        .IsUnique()
                        .HasDatabaseName("ix_pay_pal_subscriptions_pay_pal_subscription_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_pay_pal_subscriptions_user_id");

                    b.ToTable("pay_pal_subscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalVaultedPayment", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pay_pal_vaulted_payments");

                    b.HasIndex("PayPalCustomerId")
                        .HasDatabaseName("ix_pay_pal_vaulted_payments_pay_pal_customer_id");

                    b.HasIndex("UserId", "PaymentTokenId")
                        .IsUnique()
                        .HasDatabaseName("ix_pay_pal_vaulted_payments_user_id_payment_token_id");

                    b.ToTable("pay_pal_vaulted_payments", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.SubscriptionPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("PayPalCaptureId")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("pay_pal_capture_id");
                    ...
                    b.HasIndex("PayPalCaptureId")
                        .HasDatabaseName("ix_subscription_payments_pay_pal_capture_id");

                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_subscription_payments_subscription_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.UsernameHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_username_histories");

                    b.HasIndex("ProfileId")
                        .HasDatabaseName("ix_username_histories_profile_id");

                    b.ToTable("username_histories", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.LeaderboardSnapshot", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.Profile", "Profile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_leaderboard_snapshots_profiles_profile_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalSubscription", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.User", "User")
                        .WithMany("PayPalSubscriptions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pay_pal_subscriptions_users_user_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalVaultedPayment", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pay_pal_vaulted_payments_users_user_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.SubscriptionPayment", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.PayPalSubscription", "Subscription")
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_subscription_payments_pay_pal_subscriptions_subscription_id");
                    ...
                    b.HasOne("CryptoCompete.Api.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_payments_users_user_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.UsernameHistory", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.Profile", "Profile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_username_histories_profiles_profile_id");
