...
namespace cryptocompete_api.Migrations
{
    ...
    [Migration("20260222154204_AddCryptocurrencyUpdatedAtAndDeactivatedAt")]
    partial class AddCryptocurrencyUpdatedAtAndDeactivatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalSubscription", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_paypal_subscriptions");

                    b.HasIndex("PayPalSubscriptionId")
                        .IsUnique()
                        .HasDatabaseName("ix_paypal_subscriptions_pay_pal_subscription_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PriceAlarm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("price_alarms", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PayPalSubscription", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_paypal_subscriptions_users_user_id");
            ...
            modelBuilder.Entity("CryptoCompete.Api.Models.PriceAlarm", b =>
                {
                    b.HasOne("CryptoCompete.Api.Models.Cryptocurrency", "Cryptocurrency")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_price_alarms_cryptocurrencies_cryptocurrency_id");
                    ...
                    b.HasOne("CryptoCompete.Api.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_price_alarms_users_user_id");
