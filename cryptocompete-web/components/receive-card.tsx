...
export function ReceiveCard({ value, currency, supportedCurrencies, onChange }: ReceiveCardProps) {
  ...
  return (
    <div className="space-y-2">
      <span className="text-sm text-muted-foreground">{t("youReceive")}</span>
